...
from models.model import WMIMVDR

def my_WMIMVDR(args,pretrained=False, depth=12, num_heads=9, cuda='cuda:0', **kwargs):
    pre_Path = kwargs['pre_Path']
    kwargs.pop('pre_Path', None)
    model = WMIMVDR(patch_size=16, channel_ratio=6, embed_dim=576, depth=depth,
